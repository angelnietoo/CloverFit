...
<div class="container py-4">
    ...
    <form action="{{ route('classes.store') }}" method="POST" enctype="multipart/form-data" class="card">
        @csrf
        <div class="card-body">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" id="max_members" name="max_members" class="form-control @error('max_members') is-invalid @enderror" 
                       min="1" max="100" required value="{{ old('max_members', 20) }}">
            ...
            <div class="mb-3">
                <div class="form-check">
                    <input type="checkbox" id="is_active" name="is_active" class="form-check-input" 
                           value="1" checked {{ old('is_active') != '' ? 'checked' : '' }}>
