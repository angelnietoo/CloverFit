...
<div class="relative px-4 py-8 sm:px-6 lg:px-8 flex flex-col items-center justify-start w-full pb-16 sm:pb-20">
    ...
    <div class="w-full max-w-3xl">
        ...
        <form action="{{ route('suscripcion.pagar') }}" method="POST" class="mt-10">
            @csrf
        ...
        Sin embargo, debido a las políticas de verificación y seguridad, este tipo de documentos deben ser presentados
        físicamente en el establecimiento para aplicar el descuento. 
