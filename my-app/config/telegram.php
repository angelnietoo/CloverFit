...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Options to pass to the HTTP client (Guzzle by default)
    | Useful for configuring SSL verification and other cURL options
    |
    */
    'http_client_options' => [
        // Para desarrollo o si tienes problemas de SSL, puedes desactivar la verificación
